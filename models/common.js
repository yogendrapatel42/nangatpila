...
var common = {
    ...
    saveMonthlyVisit: function(data, callback) {
        return db.query(`INSERT INTO monthly_visit (child_id, visit_date, heigth, weigth, muac, remark, image,mitra_id) VALUES (?, ?, ?, ?, ?, ?, ?,?)`, [data.child_id, dateFormat(data.visit_date, "yyyy-mm-dd"), data.heigth, data.weigth, data.muac, data.remark, data.baseImage, data.mitra_id], callback);
    },
